...
public class GameWindow extends JPanel implements Screen {
    ...
    public GameWindow(Runnable exit, Clock time) {
        ...
        JPanel icono1 = crearIcono("Robbin Hub", Utils.escalarIcono(ruta+"RobbinHub(icono).png", 75));
        desktopIconsLayer.add(icono1);
        JPanel icono2 = crearIcono("Telégrafo de Montecristo", Utils.escalarIcono(ruta+"TelegrafoDeMontecristo(icono)(1).png", 75));
        desktopIconsLayer.add(icono2);
        JPanel icono3 = crearIcono("Stats.U", Utils.escalarIcono(ruta+"Doors(Closed).png", 50));
        desktopIconsLayer.add(icono3);
        JPanel icono4 = crearIcono("Tienda", Utils.escalarIcono(ruta+"Doors(Closed).png", 50));
        desktopIconsLayer.add(icono4);
        JPanel icono5 = crearIcono("BreakRoom", Utils.escalarIcono(ruta+"Doors(Closed).png", 50));
        ...
        // Botón inicio
        JButton inicio = new JButton(Utils.escalarIcono(ruta+"Doors(Closed).png", 25));
        inicio.setRolloverIcon(Utils.escalarIcono(ruta+"Doors(Open).png", 25));
        inicio.setPressedIcon(Utils.escalarIcono(ruta+"Doors(Open).png", 25));
